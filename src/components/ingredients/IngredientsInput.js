...
export class IngredientsInput extends Component {
  ...
  handleOnIngredientsNameChange(event) {
    this.setState({
  ...
  render(){
    return(
      <form onSubmit={this.handleOnSubmit.bind(this)}>
        <p>
          <input type='text' onChange={this.handleOnIngredientsNameChange.bind(this)} placeholder='Ingredient Name' />
        </p>
        <p>
          <input type='text'
            onChange={this.handleOnCaloriesChange.bind(this)} placeholder='Calories' />
        </p>
        <input type='submit' />
      </form>
    )
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({
    createIngredient: createIngredient}, dispatch)
}
